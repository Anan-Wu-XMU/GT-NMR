...
import gt  # noqa, register custom modules
from gt.optimizer.extra_optimizers import ExtendedSchedulerConfig

from torch_geometric.graphgym.cmd_args import parse_args
#from custom_parse_args import parse_args
from torch_geometric.graphgym.config import (cfg, dump_cfg,
                                             # set_agg_dir,
                                             set_cfg, load_cfg,
                                             makedirs_rm_exist)
#from torch_geometric.graphgym.loader import create_loader
from gt.loader.create_loader import create_loader
...
from gt.finetuning import load_pretrained_model_cfg, \
    init_model_from_pretrained
from gt.logger import create_logger
...
if __name__ == '__main__':
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        if cfg.dataset.name == 'CustomInference':
            print("CustomInference dataset is used, skipping model info")
            # Start training
